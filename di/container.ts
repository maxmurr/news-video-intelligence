...
import { createTranscriptChunksModule } from '@/di/modules/transcript-chunks.module';
...
ApplicationContainer.load(Symbol('TranscriptChunksModule'), createTranscriptChunksModule());
